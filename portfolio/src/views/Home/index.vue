<template>
  <div class="home-container">
    ...
    <div class="home-container__skills-showcase">
      ...
      <text-card-block class="page-work-section" :title="'My work'" :iconClass="'fas fa-stream'" :theme="'light'" :paragraphText="'Here are some projects I have worked on. Want a commission?'" :paragraphEmphasisText="'Contact me.'" :buttons="[]" :items="getCategories.data" />
    </div>
  </div>
</template>
