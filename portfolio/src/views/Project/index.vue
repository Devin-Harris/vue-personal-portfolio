<template>
  <div class="project-container">
    ...
    <div v-if="projectEditor">
      ...
      <editor-heading :title="projectEditorTitle" :btnText="'Home'" :class="{ topSpacing: !$route.params.projectSubCategory }" />
    ...
    <div v-else-if="projectHasSubCategory && !projectSubCategory">
      <page-heading class="page-heading-card" v-if="!projectEditor" @heading-button-click="headingBtnClick()" :title="projectCategory" :subTitle="''" :btnText="'My other projects'" :isSocialMediaShown="true" :isIllustrationShown="false" />
      <!-- <background-animation /> -->
    ...
    <div v-else-if="projectHasSubCategory && projectSubCategory">
      <page-heading class="page-heading-card" v-if="!projectEditor" @heading-button-click="webProjectsClick()" :title="this.$route.params.projectName" :subTitle="projectSubCategory" :btnText="'My other projects'" :isSocialMediaShown="true" :isIllustrationShown="false" />
      <!-- <background-animation /> -->
      <text-button-block
