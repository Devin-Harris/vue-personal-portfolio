...
// Mongoose methods
mongoose.connect(
   `mongodb+srv://${process.env.MONGO_USERNAME}:${process.env.PASS}@cluster0.fvr3j.mongodb.net/${process.env.DB}?retryWrites=true&w=majority`,
   {
   ...
   transporter.sendMail(mailOptions, (error, info) => {
      if (error) {
         res.send({
            ...
            message: {
               title: 'Oh no!',
               subTitle: 'There was an error sending your message.',
            },
         });
      } else {
         res.send({
            ...
            message: {
               title: 'Message sent!',
               subTitle: 'I will try to respond as soon as possible.',
            },
         });
      }
   });
